...
public class RecipeController {
    ...
    private static final Recipe[] ALL_RECIPES = {
            ...
            new Recipe( new Ingredient[] { new Bun(), new Patty(), new Lettuce(), new Bun() }),
            new Recipe( new Ingredient[] { new Bun(), new Patty(), new Sauce(), new Bun() }),
            new Recipe( new Ingredient[] { new Bun(), new Patty(), new Tomato(), new Sauce(), new Bun() }),
            new Recipe( new Ingredient[] { new Bun(), new Patty(), new Lettuce(), new Sauce(), new Bun() }),
            new Recipe( new Ingredient[] { new Bun(), new Tomato(), new Sauce(), new Lettuce(), new Bun() }),
            ...
            new Recipe( new Ingredient[] { new Bun(), new Patty(), new Sauce(), new Tomato(), new Patty(), new Lettuce(), new Bun() })
    };
